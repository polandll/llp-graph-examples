...
schema.edgeLabel('includeIn').multiple().create()
schema.edgeLabel('includes').properties('numServ').add()
schema.edgeLabel('includes').connection('meal_item','meal').add()
schema.edgeLabel('includes').connection('meal','recipe').add()
schema.edgeLabel('includes').connection('meal','book').add()
schema.edgeLabel('includes').connection('recipe','book').add()
schema.edgeLabel('includes').connection('ingredient','recipe').add()
