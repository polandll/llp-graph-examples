...
// This is the old style, but timestamps seemed fixed
// johnDoe.addEdge('rated', beefBourguignon, 'timestamp', Instant.parse('2014-01-01T00:00:00.00Z'), 'stars', 5, 'comment', 'Pretty tasty!')
johnDoe.addEdge('rated', beefBourguignon, 'timestamp', '2014-01-01T10:10:00.00Z', 'stars', 5, 'comment', 'Pretty tasty!')
johnSmith.addEdge('rated', beefBourguignon, 'timestamp', '2014-01-23T00:00:00.00Z'), 'stars', 4)
janeDoe.addEdge('rated', beefBourguignon, 'timestamp', '2014-02-01', 'stars', 5, 'comment', 'Yummy!')
sharonSmith.addEdge('rated', beefBourguignon, 'timestamp', '2015-01-01', 'stars', 3, 'comment', 'It was okay.')
johnDoe.addEdge('rated', spicyMeatLoaf, 'timestamp', '2015-12-31', 'stars', 4, 'comment', 'Really spicy - be careful!')
sharonSmith.addEdge('rated', spicyMeatLoaf, 'timestamp', '2014-07-23', 'stars', 3, 'comment', 'Too spicy for me. Use less garlic.')
janeDoe.addEdge('rated', carrotSoup, 'timestamp', '2015-12-30', 'stars', 5, 'comment', 'Loved this soup! Yummy vegetarian!')

// Traversal to find reviews with stars of 4 or greater and a ratedDate more recent than
// g.E().hasLabel('rated').has('stars',gte(4)).has('timestamp', gte(Instant.parse('2014-01-31T00:00:00.00Z'))).valueMap()
// gremlin> g.E().hasLabel('rated','timestamp','2014-01-01T10:10:00Z').values()
