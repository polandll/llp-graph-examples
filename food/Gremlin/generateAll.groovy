...
Vertex johnDoe = graph.addVertex(label, 'reviewer', 'myId', 400, 'revname','John Doe')
Vertex johnSmith = graph.addVertex(label, 'reviewer', 'myId', 401, 'revname','John Smith')
Vertex janeDoe = graph.addVertex(label, 'reviewer', 'myId', 402, 'revname','Jane Doe')
Vertex sharonSmith = graph.addVertex(label, 'reviewer', 'myId', 403, 'revname','Sharon Smith')
