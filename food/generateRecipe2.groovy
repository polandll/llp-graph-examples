...
wildMushroomStroganoff = graph.addVertex('id', 203, label, 'recipe', 'recipeTitle', 'Wild MushroomStroganoff', 'instructions', 'Cook the egg noodles according to the package directions and keep warm. Heat 1 1/2 tablespoons of the oliveoil in a large saute pan over medium-high heat.')
...
roastPorkLoin = graph.addVertex('id', 207, label, 'recipe', 'recipeTitle', 'Roast Pork Loin', 'instructions', 'The day before, separate the meat from the ribs, stopping about 1 inch before the end of the bones. inside and out with salt and pepper and refrigerate overnight.')
...
// author-book edges
juliaChild.addEdge('authored', artOfFrenchCookingVolOne).next()
simoneBeck.addEdge('authored', artOfFrenchCookingVolOne).next()
louisetteBertholie.addEdge('authored', artOfFrenchCookingVolOne).next()
simoneBeck.addEdge('authored',simcasCuisine).next()
patriciaSimon.addEdge('authored',simcasCuisine).next()
juliaChild.addEdge('authored', frenchChefCookbook).next()
aliceWaters.addEdge('authored', artOfSimpleFood).next()
patriciaCurtan.addEdge('authored', artOfSimpleFood).next()
kelsieKerr.addEdge('authored', artOfSimpleFood).next()
fritzStreiff.addEdge('authored', artOfSimpleFood).next()
