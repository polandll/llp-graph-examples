...
g.V().has('location', 'point', Geo.inside(Geo.point(0.0, 0.0), 1)).valueMap()
// Test that two closer points are inside distance from (0,0) to slightly more than (1,1) - squareroot of 2
g.V().has('location', 'point', Geo.inside(Geo.point(0.0, 0.0), 1.415)).valueMap()
// Test that all four points are inside distance from (0,0) to slightly more than (-2,-2) - squareroot of 8
g.V().has('location', 'point', Geo.inside(Geo.point(0.0, 0.0), 2.829)).valueMap()
...
g.V().has('lineLocation', 'line', Geo.inside(Geo.point(0.0, 0.0), 1)).valueMap()
...
g.V().has('lineLocation', 'line', Geo.inside(Geo.point(0.0, 0.0), 2.829)).valueMap()
...
g.V().has('polyLocation', 'polygon', Geo.inside(Geo.point(0.0, 0.0), 1)).valueMap()
// Test that two closer polygons are inside distance from (0,0) to slightly more than (1,1) - squareroot of 2
g.V().has('polyLocation', 'polygon', Geo.inside(Geo.point(0.0, 0.0), 1.415)).valueMap()
// Test that all four polygons are inside distance from (0,0) to slightly more than (-2,-2) - squareroot of 8
g.V().has('polyLocation', 'polygon', Geo.inside(Geo.point(0.0, 0.0), 2.829)).valueMap()
