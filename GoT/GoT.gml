...
<graph id="graph3" edgedefault="directed">
  ...
  <node id="100">
    <data key="labelV">human</data>
    <data key="hname">Daenerys</data>
    <data key="gender">F</data>
    <data key="house">Targaryen</data>
    <data key="origin">Dragonstone</data>
  </node>
  <node id="101">
    <data key="labelV">human</data>
    <data key="hname">Viserys</data>
    <data key="gender">M</data>
    <data key="house">Targaryen</data>
    <data key="origin">King's Landing</data>
  </node>
  <node id="102">
    <data key="labelV">human</data>
    <data key="hname">The King</data>
    <data key="gender">M</data>
    <data key="house">Targaryen</data>
    <data key="origin">King's Landing</data>
  </node>
  <node id="103">
    <data key="labelV">human</data>
    <data key="hname">Drogo</data>
    <data key="gender">M</data>
    <data key="house">Dothraki</data>
    <data key="origin">Vaes Dothrak</data>
  </node>
  <node id="104">
    <data key="labelV">dragon</data>
    <data key="dname">Drogon</data>
    <data key="colors">black and red</data>
  </node>
  <node id="105">
    <data key="labelV">dragon</data>
    <data key="dname">Viserion</data>
    <data key="colors">gold and red-orange</data>
  </node>
  <node id="106">
    <data key="labelV">dragon</data>
    <data key="dname">Rhaegal</data>
    <data key="colors">green bronze and yellow-orange</data>
  </node>
  <edge id="50" source="100" target="104">
    <data key="labelE">hatchedBy</data>
    <data key="hatchDate">at Drogo's funeral</data>
  </edge>
  ...
  <edge id="53" source="100" target="101">
    ...
    <data key="relationship">sister</data>
  </edge>
  <edge id="54" source="100" target="102">
    <data key="labelE">relatedBy</data>
    <data key="relationship">daughter</data>
  </edge>
  <edge id="55" source="101" target="100">
    <data key="labelE">relatedBy</data>
    <data key="relationship">brother</data>
  </edge>
  <edge id="56" source="101" target="102">
    <data key="labelE">relatedBy</data>
    <data key="relationship">son</data>
  </edge>
