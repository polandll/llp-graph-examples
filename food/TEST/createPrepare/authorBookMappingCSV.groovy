...
config dryrun: false, create_schema: false, preparation: false, load_new: true, load_vertex_threads: 3, schema_output: 'loader_output.txt'
// test with defaults, so create_schema, preparation not set
//config dryrun: false, load_new: true, load_vertex_threads: 3, schema_output: 'loader_output.txt'

// DATA INPUT
// Define the data input source (a file which can be specified via command line arguments)
// inputfiledir is the directory for the input files
inputfiledir = '/Users/lorinapoland/CLONES/graph-examples/food/CSV/authorBook/'
